...
import { Menu, Search, Bell, MessageCircle, User, Settings, LogOut, Edit, Trash2, TrendingUp, BarChart2, Briefcase, ChevronDown, ShoppingBag, BookOpen, DollarSign, Package, CheckSquare, MoreHorizontal } from 'lucide-react'; 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 space-x-4">
          ...
          <div className="flex items-center space-x-4 ml-auto">
            ...
            <NotificationIcon IconComponent={Bell} count={2} color="bg-red-500" />
            <NotificationIcon IconComponent={MessageCircle} count={2} color="bg-red-500" />
            ...
            <div className="relative flex-shrink-0">
                ...
                >
                    <img
                        ...
                        onError={(e) => {
                            ...
                            e.target.src = "https://placehold.co/40x40/7C3AED/FFFFFF?text=JP"; 
                        }}
                    />
                </div>
                ...
                {isProfileMenuOpen && (
                    ...
                    >
                        ...
                        <a href="#" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-indigo-50 transition duration-100 ease-in-out">
                        ...
                        <a href="#" className="flex items-center px-4 py-2 text-sm text-red-600 hover:bg-red-50 border-t mt-1 transition duration-100 ease-in-out">
...
const UserCard = ({ name, role }) => {
    ...
    const avatarUrl = `https://placehold.co/50x50/${role === 'Admin' ? '7C3AED' : 'EC4899'}/FFFFFF?text=${avatarText}`;
        ...
        <div className="flex items-center justify-between p-3 mb-2 bg-white rounded-xl shadow-md border border-gray-100 hover:shadow-lg transition duration-200 ease-in-out">
            <div className="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p className={`text-xs ${role === 'Admin' ? 'text-indigo-600 font-medium' : 'text-gray-500'}`}>{role}</p>
                </div>
            </div>
            <div className="flex space-x-2 text-gray-400">
                <button className="p-1 hover:text-indigo-500 transition"><Edit className="w-4 h-4" /></button>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-xl border border-gray-100">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <button className="p-1 text-gray-400 hover:text-gray-700 transition"><MoreHorizontal className="w-5 h-5" /></button>
                        </div>
                        ...
                        <div className="flex justify-center items-center mb-6 border border-gray-200 rounded-full w-40 mx-auto">
                            ...
                            <input type="text" placeholder="Search" className="text-xs w-full py-1 px-3 rounded-l-full focus:outline-none"/>
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-xl border border-gray-100">
                        <div className="flex justify-between items-center mb-6">
                            <h2 className="text-xl font-bold text-gray-900">Sales of the last week</h2>
                            <button className="p-1 text-gray-400 hover:text-gray-700 transition"><MoreHorizontal className="w-5 h-5" /></button>
                        </div>
                            ...
                            <div className="relative w-36 h-36">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center">
                                    <div className="text-center">
                                        <p className="text-3xl font-extrabold text-indigo-700">74%</p>
                        ...
                        <div className="space-y-5 mt-8">
                            ...
                            <div className="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">Authors with the best sales</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start">
                                ...
                                <div>
                                    <p className="font-semibold text-gray-800">Total sales lead</p>
                                    <p className="text-sm text-gray-500">40% increased on week-to-week reports</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start">
                                ...
                                <div>
                                    <p className="font-semibold text-gray-800">Average Bestseller</p>
                                    <p className="text-sm text-gray-500">Pitstop Email Marketing</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-xl border border-gray-100">
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-8">
                            <DetailCard icon={ShoppingBag} title="Sales" value="$2,034" color="text-indigo-600" iconBg="bg-indigo-100" />
                            <DetailCard icon={BookOpen} title="Commision" value="$706" color="text-pink-600" iconBg="bg-pink-100" />
                            <DetailCard icon={Package} title="Average Bid" value="$49" color="text-teal-600" iconBg="bg-teal-100" />
                            <DetailCard icon={CheckSquare} title="All Time Sales" value="$5.8M" color="text-green-600" iconBg="bg-green-100" />
                        </div>
                        ...
                        <div className="h-56">
                            <svg viewBox="0 0 300 150" className="w-full h-full">
                                ...
                                <linearGradient id="purpleGradient" x1="0%" y1="0%" x2="0%" y2="100%">
                                    <stop offset="0%" style={{stopColor: 'rgba(124, 69, 240, 0.4)', stopOpacity: 1}} />
                                    <stop offset="100%" style={{stopColor: 'rgba(124, 69, 240, 0.0)', stopOpacity: 0}} />
                                </linearGradient>
                                <path 
