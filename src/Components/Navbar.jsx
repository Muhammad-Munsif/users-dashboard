...
import { Menu, Search, Bell, MessageCircle, User, Settings, LogOut } from 'lucide-react'; 
...
const Navbar = () => {
  ...
  // New state to control the visibility of the profile menu
            ...
            <div className="relative flex-shrink-0">
                ...
                {isProfileMenuOpen && (
                    <div 
                        ...
                        // Positioned just below the navbar
                        style={{ top: '100%' }} 
                    >
                        {/* User Info Header */}
