    ...
    <div className="p-4 md:p-6">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <input name="lastName" value={form.lastName} onChange={handleChange} placeholder="Last Name" className="h-11 rounded-md border border-gray-200 px-4 text-sm outline-none" />
        ...
        <button type="submit" className="mt-6 w-full h-11 rounded-md bg-indigo-600 text-white">Add User</button>
      </form>
    </div>
  )
}
